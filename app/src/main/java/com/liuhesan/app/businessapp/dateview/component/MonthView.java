package com.liuhesan.app.businessapp.dateview.component;
...
import com.liuhesan.app.businessapp.dateview.utils.DateUtils;
...
public abstract class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attrs) {
        ...
        setRightDate();
        createTheme();
        baseRowSize = rowSize = theme == null ? 60 : theme.dateHeight();
