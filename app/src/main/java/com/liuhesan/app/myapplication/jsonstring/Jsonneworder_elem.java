package com.liuhesan.app.myapplication.jsonstring;

/**
 * Created by Tao on 2016/11/21.
 */

public class Jsonneworder_elem {
    public  static final String neworder = "{\n" +
            "    \"ncp\": \"2.0.0\",\n" +
            "    \"id\": \"7ccb4de2-ea2e-498e-a6ea-d494d52f9ea3\",\n" +
            "    \"result\": [\n" +
            "        {\n" +
            "            \"id\": \"101588903170589082\",\n" +
            "            \"shopId\": 511175,\n" +
            "            \"shopName\": \"河东涮牛肚\",\n" +
            "            \"restaurantName\": \"河东涮牛肚\",\n" +
            "            \"daySn\": 1,\n" +
            "            \"activeTime\": \"2016-11-24T11:09:02\",\n" +
            "            \"remark\": \"\",\n" +
            "            \"payment\": \"ONLINE\",\n" +
            "            \"bookedTime\": null,\n" +
            "            \"invoiceTitle\": null,\n" +
            ...
            "            \"tips\": [],\n" +
            "            \"followed\": false,\n" +
            "            \"consigneeName\": \"石泰龙 先生\",\n" +
            "            \"consigneePhones\": [\n" +
            "                \"18335192057\"\n" +
            "            ],\n" +
            "            \"consigneeAddress\": \"臻观苑(北区)坞城南路山西财经大学南校区往南100米臻观苑B区9号楼1单元802\",\n" +
            "            \"distance\": \"5.05km\",\n" +
            "            \"times\": 0,\n" +
            "            \"payAmount\": 47,\n" +
            "            \"income\": 44.9,\n" +
