...
public class DistributionFragment extends Fragment {
    private final static String TAG = "Distribution";
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_order_distribution, container, false);
        //日期接收注册
    ...
    private void getData(int page,String date) {
        QueryHistoryorder.getInstance(mContext).queryData(page, "5", "8",date, new StringCallback() {
            @Override
